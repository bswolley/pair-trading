...
/**
 * Quick pair fitness check - returns correlation, cointegration, z-score, half-life
 * @param {number[]} prices1 - First price series (e.g., 30 days)
 * @param {number[]} prices2 - Second price series
 * @returns {{ correlation: number, beta: number, isCointegrated: boolean, zScore: number, halfLife: number, meanReversionRate: number }}
 */
